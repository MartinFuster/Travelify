  ...
  return (
    <section className="terms-and-conditions">
      ...
      <div className="container">
        ...
        <p className="paragraph" data-aos="zoom">
          Welcome to Travelify! These terms and conditions outline the rules and
          regulations for the use of Travelify's Website, located at
          travelify.com. By accessing this website we assume you accept these
          terms and conditions. Do not continue to use Travelify if you do not
        ...
        <h1
          className="heading-secondary u-margin-top-medium u-margin-bottom-small"
          data-aos="zoom"
        >
          Cookies
        </h1>
        <p className="paragraph" data-aos="fade">
          We employ the use of cookies. By accessing Travelify, you agreed to
          use cookies in agreement with the Travelify's Privacy Policy. Most
        ...
        <p className="paragraph" data-aos="fade">
          Unless otherwise stated, Travelify and/or its licensors own the
          intellectual property rights for all material on Travelify. All
          intellectual property rights are reserved. You may access this from
          Travelify for your own personal use subjected to restrictions set in
        ...
        <ul className="conditions-list">
          <li className="paragraph" data-aos="fade-up">
          ...
          <li className="paragraph u-margin-bottom-medium" data-aos="fade-up">
        ...
        <p className="paragraph" data-aos="fade">
          ...
          Travelify does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Travelify,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Travelify shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p className="paragraph" data-aos="fade">
          Travelify reserves the right to monitor all Comments and to remove any
        ...
        <p className="paragraph" data-aos="fade">
          You hereby grant Travelify a non-exclusive license to use, reproduce,
        ...
        <p className="paragraph" data-aos="fade">
          ...
          the hyperlink compensates the absence of Travelify; and (d) the link
        ...
        <p className="paragraph" data-aos="fade">
          ...
          sending an e-mail to Travelify. Please include your name, your
        ...
        <p className="paragraph" data-aos="fade">
          No use of Travelify's logo or other artwork will be allowed for
        ...
        <p className="paragraph u-margin-bottom-big" data-aos="fade">
